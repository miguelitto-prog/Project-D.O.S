...
export const serverService = {
  ...
  rename: (id, name) => api.patch(`/servers/${id}`, { name }).then((r) => r.data),
...
export const storeService = {
  catalog: () => api.get('/store/catalog').then((r) => r.data),
  subscription: () => api.get('/store/subscription').then((r) => r.data),
  checkout: (itemKey) => api.post('/store/checkout', { itemKey }).then((r) => r.data),
};
