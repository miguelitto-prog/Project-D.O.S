...
// Bio + avatar em base64 podem ser maiores que o limite padrao do JSON
router.use(express.json({ limit: '4mb' }));

// Atualiza o proprio perfil (bio, avatar). Fica antes de "/:username"
// para nao ser interpretado como um nome de usuario.
router.patch('/me', async (req, res) => {
  ...
  try {
    const result = await pool.query(
      ...
      [bio !== undefined ? bio : null, avatarUrl !== undefined ? avatarUrl : null, req.userId]
    );
